...
export default function Opener7() {
    return (
        <div className="relative h-full bg-indigo-100 p-8 md:p-16">
            <img className="z-0 max-h-full absolute top-1/2 translate-x-16 -translate-y-1/2 right-8vw md:right-4vw p-8vw md:p-4vw" src={Phone1SVG} alt="Phone1SVG"></img>

            <div className="flex flex-col w-full h-full">
                <div className="z-10 flex flex-col m-auto">
                <h1 className="w-60vw lg:w-40vw text-center text-4xl md:text-5xl leading-tight font-bold m-auto">Experience the full potential of prototyping.</h1>
