        ...
        <div className="h-100vw md:h-62.5vw">
            <div className="h-full flex flex-col md:flex-row">
                <div className="relative w-30.625vw flex-none z-10 bg-white">
                    <div className="absolute left-15vw md:left-10vw top-50vw md:top-19.5vw w-70vw md:w-40vw">
                ...
                <div className="z-0 flex">
                    <img className="z-0 max-x-full h-auto md:max-w-none md:-ml-12vw" src={Intro}></img>
                </div>
            </div>
        </div>
    )
